...
public class HexUtilTest extends TestCase {
    ...
    @Test
    public void testHexToBytes15() {
        thrown.expect(NumberFormatException.class);
        HexUtil.hexToBytes("S");
    }

    @Test
    public void testHexToBytes16() {
        thrown.expect(NumberFormatException.class);
        HexUtil.hexToBytes("S", 1);
    }

    @Test
    public void testHexToBytes17() {
        thrown.expect(ArrayIndexOutOfBoundsException.class);
        HexUtil.hexToBytes("0123456789ABCDEF", -1);
    }

    @Test
    public void testHexToBytes18() {
        thrown.expect(NegativeArraySizeException.class);
        HexUtil.hexToBytes("0123456789ABCDEF", -2147483648);
    }

    @Test
    public void testHexToBytes19() throws IndexOutOfBoundsException, NumberFormatException {
    ...
    @Test
    public void testHexToBytes20() throws IndexOutOfBoundsException, NumberFormatException {
        thrown.expect(IndexOutOfBoundsException.class);
        HexUtil.hexToBytes("Output buffer too small for input (", new byte[]{65, 65, 65, 65, 65, 65, 65, 65}, 1);
    }

    @Test
    public void testHexToBytes21() throws IndexOutOfBoundsException, NumberFormatException {
        thrown.expect(NumberFormatException.class);
        HexUtil.hexToBytes("S", new byte[]{65, 65, 65, 65, 65, 65, 65, 65}, 1);
    }

    @Test
    public void testHexToBytes22() throws IndexOutOfBoundsException, NumberFormatException {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testHexToBytes23() throws IndexOutOfBoundsException, NumberFormatException {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testHexToBytes24() throws IndexOutOfBoundsException, NumberFormatException {
        thrown.expect(ArrayIndexOutOfBoundsException.class);
        HexUtil.hexToBytes("0123456789ABCDEF", new byte[]{65, 65, 65, 65, 65, 65, 65, 65}, -1);
    }
    ...
    @Test
    public void testBitsToHexString5() {
        assertEquals("01", HexUtil.bitsToHexString(BitSet.valueOf(new long[]{1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L}), 3));
    }

    @Test
    public void testBitsToHexString6() {
        assertEquals("", HexUtil.bitsToHexString(BitSet.valueOf(new long[]{1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L}), 0));
    }

    @Test
    public void testBitsToHexString7() {
        thrown.expect(NegativeArraySizeException.class);
        HexUtil.bitsToHexString(BitSet.valueOf(new long[]{1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L}), -2147483648);
    }
    ...
    @Test
    public void testHexToBits8() {
        thrown.expect(NumberFormatException.class);
        HexUtil.hexToBits("S", BitSet.valueOf(new long[]{1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L}), 3);
    }

    @Test
    public void testHexToBits9() {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testWriteBigInteger3() throws IOException {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testWriteBigInteger4() throws IOException {
        BigInteger integer = BigInteger.valueOf(-1L);
        thrown.expect(IllegalStateException.class);
        HexUtil.writeBigInteger(integer, new DataOutputStream(new ByteArrayOutputStream()));
    }
    ...
    @Test
    public void testReadBigInteger5() throws IOException {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testReadBigInteger6() throws IOException {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testReadBigInteger7() throws IOException {
        thrown.expect(IOException.class);
        HexUtil.readBigInteger(new DataInputStream(new ByteArrayInputStream(
                new byte[]{-1, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65})));
    }
    ...
    @Test
    public void testReadBigInteger8() throws IOException {
        assertEquals("0", HexUtil
                .readBigInteger(new DataInputStream(new ByteArrayInputStream(
                        new byte[]{0, 0, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65})))
                .toString());
    ...
    @Test
    public void testBytesToHex5() {
        thrown.expect(IllegalArgumentException.class);
        HexUtil.bytesToHex(new byte[]{}, 1, 3);
    }

    @Test
    public void testBytesToHex6() {
        thrown.expect(ArrayIndexOutOfBoundsException.class);
        HexUtil.bytesToHex(new byte[]{65, 65, 65, 65, 65, 65, 65, 65}, -1, 3);
    }

    @Test
    public void testBytesToHex7() {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testBytesToHexAppend5() {
        // TODO: This test is incomplete.
        //   Reason: No meaningful assertions found.
        //   To help Diffblue Cover to find assertions, please add getters to the
        //   class under test that return fields written by the method under test.
    ...
    @Test
    public void testBytesToHexAppend6() {
        thrown.expect(IllegalArgumentException.class);
        HexUtil.bytesToHexAppend(new byte[]{}, 1, 3, new StringBuilder());
    }

    @Test
    public void testBytesToHexAppend7() {
        thrown.expect(ArrayIndexOutOfBoundsException.class);
        HexUtil.bytesToHexAppend(new byte[]{65, 65, 65, 65, 65, 65, 65, 65}, -1, 3, new StringBuilder());
    }

    @Test
    public void testBytesToHexAppend8() {
        thrown.expect(IllegalArgumentException.class);
        HexUtil.bytesToHexAppend(new byte[]{}, 1, 3, null);
    }
}
